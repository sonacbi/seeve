...
export function useCellEditor({
    ...
    const commitDraft = () => {
        ...
        const cellWidthPx = editorRef.current.clientWidth / COLS;
        const colSpan = calcColSpan(value, cellWidthPx);

        updateCellValue(activeCell.row, activeCell.col, value, colSpan);
